...
<div class="search-bar">
  <input id="searchInput" class="search-input" placeholder="Search clothing...">
...
function searchProducts(){
  ...
  const filtered = clothingProducts.filter(p=>p.search.includes(q));
